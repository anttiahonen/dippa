...
Survey regarding JUnit contains base questions from multiple previous research studies~\cite{williams2009effectiveness,daka2014survey,li2016automatically}.
...
\begin{table}[H]
    \resizebox{\textwidth}{!}{%
        ...
        \rowcol RQ2 & Q14 & Only half of the survey respondents enjoy writing unit tests~\cite{daka2014survey,runeson2006survey} \\
        RQ1, RQ2 & Q2, Q7, Q14, Q15 & Maintaining unit tests was found hard~\cite{daka2014survey,runeson2006survey} \\
...
used for each \textit{Spock} and \textit{Spectrum}, their questions are both displayed in same tables. The only change is in the words
