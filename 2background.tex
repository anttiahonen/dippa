...
Last in this chapter, agile methodologies TDD, ATDD and BDD are reviewed.
...
\section{Java Virtual Machine} %1p
    ...
    different implementation level \textbf{Behavior Driven Development (BDD)} -testing frameworks from various JVM languages.
...
\section{Software quality assurance}
    ...
    providing value for end users and other stakeholders with minimizing defects~\cite{chelimsky2010rspec}.
    ...
    Next in this thesis testing is examined in detail through automated testing as it provides a base for agile SQA practices \textbf{Test Driven Development (TDD)},
    \textbf{Acceptance Test Driven Development (ATDD)} and BDD.
...
\section{xUnit testing frameworks} %2p
    ...
    In the next chapter, examples of JUnit are provided together with extending JUnit for integration testing of Spring Framework domain.
    Also alternatives for automated low level testing of Java-code are reviewed there. Next in this chapter,
    agile methodologies TDD, ATDD and BDD are reviewed.
...
\section{Test Driven Development} %2p
    ...
    This could be in my opinion a result of two factors: more tests written and learning curve to practice TDD.
...
\section{Acceptance Test Driven Development}
    ...
    between all people involved. ATDD can potentially reduce the \textit{ambiquity, noise} and \textit{over-specfication}~\cite{haugset2012automated}
...
\section{Behavior Driven Development} %2p
    ...
    section when testing framework Spock is examined. Figure \ref{fig:BDD} shows how these stories and scenarios relate to system design.
    ...
    In the next section implementation level BDD testing frameworks are examined in more detail. These frameworks are later on used to study
    the differences in developer low level testing practices and perception towards automated low level testing
